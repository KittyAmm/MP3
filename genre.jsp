			...
			<!--logo and iconic logo end-->
				...
				<!--sidebar nav start-->
					...
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="Nouveaute.jsp"><i class="camera"></i> <span>Nouveauté</span></a></li>
						<li><a href="radio.html"><i class="lnr lnr-users"></i> <span>Artistes</span></a></li> 
						<li><a href="Album.jsp"><i class="lnr lnr-music-note"></i> <span>Albums</span></a></li>						
						<li class="menu-list"><a href="Genre.jsp"><i class="lnr lnr-indent-increase"></i> <span>Genre</span></a></li>
					...
					<!--//End-albums-->
						...
						<div class="review-slider">
								<div class="tittle-head">
									<h3 class="tittle">Genre</h3>
									<div class="clearfix"> </div>
								</div>
								 <ul id="flexiselDemo1">
								<li>
									<a href="single.jsp"><img src="images/v1.jpg" alt=""/></a>
									<div class="slide-title"><h4>Adele21 </div>
									<div class="date-city">
										<h5>Jan-02-16</h5>
										<div class="buy-tickets">
											<a href="single.jsp">Voir chansons</a>
										</div>
									</div>
								</li>
								<li>
									<a href="single.jsp"><img src="images/v2.jpg" alt=""/></a>
								...
								<li>
									<a href="single.jsp"><img src="images/v3.jpg" alt=""/></a>
								...
								<li>
									<a href="single.jsp"><img src="images/v4.jpg" alt=""/></a>
								...
								<li>
									<a href="single.jsp"><img src="images/v5.jpg" alt=""/></a>
								...
								<li>
									<a href="single.jsp"><img src="images/v6.jpg" alt=""/></a>
								...
								<li>
									<a href="single.jsp"><img src="images/v6.jpeg" alt=""/></a>
