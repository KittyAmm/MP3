                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    <li class="active">
                        <c:forEach items="${menus}" var="menu">
                               <li><a href="${menu.lien}"><i class="${menu.class}"></i> <span>${menu.nom}</span></a></li> 
                        </c:forEach>
                   <%--  <li><a href="//${chanson.id}"><i class="lnr lnr-smile"></i> <span>Artistes</span></a></li>
                    <li><a href=""><i class="lnr lnr-book"></i> <span>Albums</span></a></li>
                    <li><a href=""><i class="lnr lnr-chart-bars"></i><span>Genres</span></a></li>
                    <li><a href="/IndexController/profil"><i class="lnr lnr-user"></i><span>Profil</span></a></li>  --%>
                </ul>
            </div>
        </div>
        ...
        <div class="header-section">
            ...
            <div class="menu-right">
                <div class="profile_details">
                    <div class="col-lg-9 serch-part" style="padding-top: 10px">
                         ...
                         <!-- <input  class="" placeholder="Rechercher" type="search" name="search"> -->
                         <!-- </form> -->
                         <!-- Load icon library -->
                                ...
                                <form action="">
                                 <input type="text" placeholder="Rechercher" name="search">
                                    ...
                                    <div class="col-md-6 content-grid">
                                        <c:forEach items="${Mp3Info}" var="chansons">
                                        ${chansons.id}<i class="lnr lnr-film-play"></i>
